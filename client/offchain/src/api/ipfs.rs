...
async fn ipfs_get(ipfs: &Ipfs<ipfs::Types>, path: IpfsPath) -> Result<Vec<u8>, ipfs::Error> {
...
pub fn ipfs(ipfs_node: ipfs::Ipfs<ipfs::Types>) -> (IpfsApi, IpfsWorker) {
...
async fn ipfs_request(ipfs: ipfs::Ipfs<ipfs::Types>, request: IpfsRequest) -> Result<IpfsNativeResponse, ipfs::Error> {
    match request {
        IpfsRequest::Addrs => {
