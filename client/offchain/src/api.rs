...
use sp_core::offchain::{
	Externalities as OffchainExt, HttpRequestId, IpfsRequest, IpfsRequestId, IpfsRequestStatus,
	Timestamp, HttpRequestStatus, HttpError, OffchainStorage, OpaqueNetworkState, OpaqueMultiaddr,
	StorageKind,
};
